...
func createQueryShortChanIDs(encodingType lnwire.ShortChanIDEncoding) lnwire.Message {
	var chainHash chainhash.Hash
	chainHash[1] = 6
...
func createReplyChannelRange(encodingType lnwire.ShortChanIDEncoding) lnwire.Message {
...
func main() {
	...
	writeMessage(f, createQueryShortChanIDs(lnwire.EncodingSortedPlain))
	writeMessage(f, createQueryShortChanIDs(lnwire.EncodingSortedZlib))

	writeMessage(f, createReplyChannelRange(lnwire.EncodingSortedPlain))
	writeMessage(f, createReplyChannelRange(lnwire.EncodingSortedZlib))
