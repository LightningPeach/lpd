...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0cwallet.proto\x12\twalletrpc\"H\n\x11NewAddressRequest\x123\n\taddr\
    _type\x18\x01\x20\x01(\x0e2\x16.walletrpc.AddressTypeR\x08addrType\".\n\
    \x12NewAddressResponse\x12\x18\n\x07address\x18\x01\x20\x01(\tR\x07addre\
    ss\"N\n\x17NewChangeAddressRequest\x123\n\taddr_type\x18\x01\x20\x01(\
    \x0e2\x16.walletrpc.AddressTypeR\x08addrType\"4\n\x18NewChangeAddressRes\
    ponse\x12\x18\n\x07address\x18\x01\x20\x01(\tR\x07address\"2\n\x08OutPoi\
    nt\x12\x12\n\x04txid\x18\x01\x20\x01(\x0cR\x04txid\x12\x12\n\x04vout\x18\
    \x02\x20\x01(\rR\x04vout\"\x83\x01\n\x04Utxo\x12\x14\n\x05value\x18\x01\
    \x20\x01(\x04R\x05value\x120\n\tout_point\x18\x02\x20\x01(\x0b2\x13.wall\
    etrpc.OutPointR\x08outPoint\x123\n\taddr_type\x18\x03\x20\x01(\x0e2\x16.\
    walletrpc.AddressTypeR\x08addrType\"\x14\n\x12GetUtxoListRequest\"<\n\
    \x13GetUtxoListResponse\x12%\n\x05utxos\x18\x01\x20\x03(\x0b2\x0f.wallet\
    rpc.UtxoR\x05utxos\"\x16\n\x14WalletBalanceRequest\"<\n\x15WalletBalance\
    Response\x12#\n\rtotal_balance\x18\x01\x20\x01(\x04R\x0ctotalBalance\"-\
    \n\x12UnlockCoinsRequest\x12\x17\n\x07lock_id\x18\x01\x20\x01(\x04R\x06l\
    ockId\"\x15\n\x13UnlockCoinsResponse\"\x9b\x01\n\x10SendCoinsRequest\x12\
    \x1b\n\tdest_addr\x18\x01\x20\x01(\tR\x08destAddr\x12\x10\n\x03amt\x18\
    \x02\x20\x01(\x04R\x03amt\x12\x16\n\x06submit\x18\x03\x20\x01(\x08R\x06s\
    ubmit\x12\x1d\n\nlock_coins\x18\x04\x20\x01(\x08R\tlockCoins\x12!\n\x0cw\
    itness_only\x18\x05\x20\x01(\x08R\x0bwitnessOnly\"X\n\x11SendCoinsRespon\
    se\x12*\n\x11serialized_raw_tx\x18\x01\x20\x01(\x0cR\x0fserializedRawTx\
    \x12\x17\n\x07lock_id\x18\x02\x20\x01(\x04R\x06lockId\"}\n\rMakeTxReques\
    t\x12%\n\x03ops\x18\x01\x20\x03(\x0b2\x13.walletrpc.OutPointR\x03ops\x12\
    \x1b\n\tdest_addr\x18\x02\x20\x01(\tR\x08destAddr\x12\x10\n\x03amt\x18\
    \x03\x20\x01(\x04R\x03amt\x12\x16\n\x06submit\x18\x04\x20\x01(\x08R\x06s\
    ubmit\"<\n\x0eMakeTxResponse\x12*\n\x11serialized_raw_tx\x18\x01\x20\x01\
    (\x0cR\x0fserializedRawTx\"\x14\n\x12SyncWithTipRequest\"\x15\n\x13SyncW\
    ithTipResponse\"\x11\n\x0fShutdownRequest\"\x12\n\x10ShutdownResponse*/\
    \n\x0bAddressType\x12\t\n\x05P2PKH\x10\0\x12\n\n\x06P2SHWH\x10\x01\x12\t\
    \n\x05P2WKH\x10\x022\xcc\x05\n\x06Wallet\x12K\n\nNewAddress\x12\x1c.wall\
    etrpc.NewAddressRequest\x1a\x1d.walletrpc.NewAddressResponse\"\0\x12]\n\
