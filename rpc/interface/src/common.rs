...
impl<'a> ::std::default::Default for &'a Satoshi {
    fn default() -> &'a Satoshi {
        <Satoshi as ::protobuf::Message>::default_instance()
    }
}
...
impl<'a> ::std::default::Default for &'a MilliSatoshi {
    fn default() -> &'a MilliSatoshi {
        <MilliSatoshi as ::protobuf::Message>::default_instance()
    }
}
