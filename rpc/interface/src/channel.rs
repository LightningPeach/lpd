...
//! Generated file from `channel.proto`
...
impl<'a> ::std::default::Default for &'a ChannelList {
    fn default() -> &'a ChannelList {
        <ChannelList as ::protobuf::Message>::default_instance()
    }
}
...
impl<'a> ::std::default::Default for &'a ChannelId {
    fn default() -> &'a ChannelId {
        <ChannelId as ::protobuf::Message>::default_instance()
    }
}
...
impl<'a> ::std::default::Default for &'a ChannelFilter {
    fn default() -> &'a ChannelFilter {
        <ChannelFilter as ::protobuf::Message>::default_instance()
    }
}
